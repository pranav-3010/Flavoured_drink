export interface Product {
   ...
   // Additional custom properties for canvas image sequence mapping
   frameCount: number;
...
export const products: Product[] = [
   {
       ...
       themeColor: "#FBC02D",
       gradient: "linear-gradient(135deg, #FFF9C4 0%, #FBC02D 100%)",
       ...
       frameCount: 192,
       fileNameTemplate: "ezgif-frame-%PAD3%.jpg"
   },
   {
       id: "chocolate",
   ...
   },
   {
       ...
       themeColor: "#EF5350",
       gradient: "linear-gradient(135deg, #FF8A80 0%, #B71C1C 100%)",
